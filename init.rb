...
Redmine::Plugin.register :ayty_custom_code do
  ...
  menu :account_menu,
        ...
        :if => Proc.new {  User.current.logged? && User.current.ayty_is_user_ayty? }

  # Colocar um menu para o AytyDashboard, nao tera nome para nao ocupar muito espaco, somente icone
  menu :top_menu,
       :ayty_dashboards,
